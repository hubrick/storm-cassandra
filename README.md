...
It's a backport of [Apache Storm Cassandra Integration](https://github.com/apache/storm/tree/master/external/storm-cassandra) to Storm 0.9.7
and a upgrade to Cassandra 3.x.x which is backward compatible with Cassandra 2.x.x.
 ...
 * Emir Dizdarevic ([ed@hubrick.com](mailto:ed@hubrick.com))
